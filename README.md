...
echo "DEEP_USE_MODE=$DEEP_USE_MODE"

if [[ -z "${HCCL_OP_EXPANSION_MODE+x}" ]]; then
  echo "HCCL_OP_EXPANSION_MODE is unset: OK"
else
  echo "ERROR: HCCL_OP_EXPANSION_MODE=$HCCL_OP_EXPANSION_MODE"
fi
